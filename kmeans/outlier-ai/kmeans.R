# https://outlier.ai/2017/02/08/clustering-k-means-clustering-in-practice/
...
dta <- read.csv(text = getURL(url = "https://raw.githubusercontent.com/OutlierAI/datadrivendaily/master/Clustering/sales_data.csv"))
...
for (p_name in names(p)) {
	ggsave(paste0("~/R-scripts/kmeans/outlier-ai/", p_name, ".png"), p[[p_name]], width = 16, height = 9)
}
